...
- **Rules** define standards, conventions, and checklists that apply broadly (e.g., "90% test coverage", "no hardcoded secrets").
- **Skills** (`skills/` directory) provide deep, actionable reference material for specific tasks (e.g., `nextjs-turbopack`, `tdd-workflow`).
